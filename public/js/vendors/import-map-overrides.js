...
!function() {
        ...
        return function(e) {
            ...
            if ("undefined" != typeof Symbol && Symbol.iterator in Object(e)) {
                var n = []
                  ...
                  , i = void 0;
                try {
                    for (var l, a = e[Symbol.iterator](); !(r = (l = a.next()).done) && (n.push(l.value),
                    !t || n.length !== t); r = !0)
                        ;
                } catch (e) {
                    o = !0,
    ...
    var y, b = "import-map-overrides-domains", w = /^\d+$/g, x = document.querySelector('meta[name="importmap-type"]'), M = document.querySelector('meta[name="'.concat(b, '"]')), k = {}, O = x ? x.getAttribute("content") : "importmap";
    if (M) {
        ...
        0 === E.indexOf("allowlist:") ? y = !E.slice("allowlist:".length).split(",").some(N) : 0 === E.indexOf("denylist:") ? y = E.slice("denylist:".length).split(",").some(N) : console.log("Invalid ".concat(b, " meta content attribute - must start with ").concat("allowlist:", " or ").concat("denylist:"))
    } else
        y = !1;
    (function() {
        try {
    ...
    y = !0),
    y || function() {
        var e, t = !!x && x.hasAttribute("server-cookie"), n = !!x && x.hasAttribute("server-only");
        window.importMapOverrides = {
            addOverride: function(e, n) {
                w.test(n) && (n = r.getUrlFromPort(e, n));
                var o = "import-map-override:" + e;
                return localStorage.setItem(o, n),
            ...
            getOverrideMap: function() {
                for (var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], t = {
                    imports: {},
                    scopes: {}
                }, n = r.getDisabledOverrides(), o = function(r, o) {
                    !e && n.indexOf(r) >= 0 || (t.imports[r] = o)
                }, i = 0; i < localStorage.length; i++) {
                    var l = localStorage.key(i);
                    0 === l.indexOf("import-map-override:") && o(l.slice("import-map-override:".length), localStorage.getItem(l))
                }
            ...
            resetOverrides: function() {
                return Object.keys(r.getOverrideMap(!0).imports).forEach((function(e) {
                    r.removeOverride(e)
                }
                )),
            ...
            enableUI: function() {
                ...
                e || ((e = document.createElement("import-map-overrides-full")).setAttribute("show-when-local-storage", "true"),
                document.body.appendChild(e));
                var t = e.getAttribute("show-when-local-storage");
                t && (localStorage.setItem(t, !0),
                e.renderWithPreact())
            },
            mergeImportMap: function(e, t) {
                ...
                for (var l in t.scopes)
                    n.scopes[l] = t.scopes[l];
                return n
            },
            getDefaultMap: function() {
                return e || (e = Array.prototype.reduce.call(document.querySelectorAll('script[type="'.concat(O, '"], script[type="overridable-importmap"]')), (function(e, t) {
                    return t.hasAttribute("data-is-importmap-override") ? e : (n = t.src ? m(t.src) : Promise.resolve(JSON.parse(t.textContent)),
            ...
            getCurrentPageMap: function() {
                return Promise.all([r.getDefaultMap(), r.getExternalOverrideMap(r.getCurrentPageExternalOverrides())]).then((function(e) {
                    var t = f(e, 2)
                      , n = t[0]
                      , o = t[1];
            ...
            getCurrentPageExternalOverrides: function() {
                var e = [];
                return document.querySelectorAll("[".concat("data-is-importmap-override", ']:not([id="import-map-overrides"])')).forEach((function(t) {
                    e.push(t.src)
                }
                )),
                e
            ...
            disableOverride: function(e) {
                ...
                return !g(t, e) && (localStorage.setItem("import-map-overrides-disabled", JSON.stringify(t.concat(e))),
                i(),
                !0)
            },
            enableOverride: function(e) {
                ...
                localStorage.setItem("import-map-overrides-disabled", JSON.stringify(t)),
                i(),
                !0)
            },
            ...
            addExternalOverride: function(e) {
                ...
                return !g(t, e) && (localStorage.setItem("import-map-overrides-external-maps", JSON.stringify(t.concat(e))),
                i(),
                !0)
            },
            removeExternalOverride: function(e) {
                var t = r.getExternalOverrides();
                return !!g(t, e) && (localStorage.setItem("import-map-overrides-external-maps", JSON.stringify(t.filter((function(t) {
                    return t !== e
                }
                )))),
                i(),
        ...
        var l, a = r.getOverrideMap(), u = r.getExternalOverrides();
        if (!n) {
            ...
            if (s) {
                ...
                l = c(r.mergeImportMap(p, a), "import-map-overrides", l),
                v()
            } else
                v(),
                Object.keys(a.imports).length > 0 && (l = c(a, "import-map-overrides", l))
        }
        function c(e, t, n) {
        ...
        function v() {
            u.length > 0 && u.forEach((function(e, t) {
    ...
    var S, C, U, I, P, D = {}, A = [], j = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
    function L(e, t) {
        for (var n in t)
            e[n] = t[n];
        return e
    ...
    function q(e, t) {
        if (null == t)
            return e.__ ? q(e.__, e.__.__k.indexOf(e) + 1) : null;
    ...
    function $(e) {
        (!e.__d && (e.__d = !0) && C.push(e) && !V.__r++ || I !== S.debounceRendering) && ((I = S.debounceRendering) || U)(V)
    }
    function V() {
        for (var e; V.__r = C.length; )
            ...
            e.some((function(e) {
                ...
                (a = t.__P) && (n = [],
                (r = L({}, i)).__v = i.__v + 1,
                o = Z(a, i, r, t.__n, void 0 !== a.ownerSVGElement, null != i.__h ? [l] : null, n, null == l ? q(i) : l, i.__h),
                ee(n, i),
                o != l && J(i)))
            }
            ))
    ...
    function B(e, t, n, r, o, i, l, a, u, s) {
        var d, p, c, m, f, v, h, g = r && r.__k || A, _ = g.length;
        for (u == D && (u = null != l ? l[0] : _ ? q(r, 0) : null),
        n.__k = [],
        d = 0; d < t.length; d++)
            if (null != (m = n.__k[d] = null == (m = t[d]) || "boolean" == typeof m ? null : "string" == typeof m || "number" == typeof m ? F(null, m, null, null, m) : Array.isArray(m) ? F(W, {
                children: m
            }, null, null, null) : null != m.__e || null != m.__c ? F(m.type, m.props, m.key, null, m.__v) : m)) {
                if (m.__ = n,
                m.__b = n.__b + 1,
                ...
                null != f ? (null == v && (v = f),
                u = H(e, m, c, g, l, f, u),
                s || "option" != n.type ? "function" == typeof n.type && (n.__d = u) : e.value = "") : u && c.__e == u && u.parentNode != e && (u = q(c))
            }
        if (n.__e = v,
    ...
    function H(e, t, n, r, o, i, l) {
        ...
        if (void 0 !== t.__d)
            ...
            e: if (null == l || l.parentNode !== e)
                ...
                for (u = l,
                s = 0; (u = u.nextSibling) && s < r.length; s += 2)
                    if (u == i)
                        break e;
                e.insertBefore(i, l),
                a = l
    ...
    function X(e, t, n, r, o) {
        ...
        "style" === t)
            ...
            e.l[t + i] = n,
            a = i ? Q : K,
            n ? r || e.addEventListener(t, a, i) : e.removeEventListener(t, a, i)) : "list" !== t && "tagName" !== t && "form" !== t && "type" !== t && "size" !== t && "download" !== t && "href" !== t && !o && t in e ? e[t] = null == n ? "" : n : "function" != typeof n && "dangerouslySetInnerHTML" !== t && (t !== (t = t.replace(/xlink:?/, "")) ? null == n || !1 === n ? e.removeAttributeNS("http://www.w3.org/1999/xlink", t.toLowerCase()) : e.setAttributeNS("http://www.w3.org/1999/xlink", t.toLowerCase(), n) : null == n || !1 === n && !/^ar/.test(t) ? e.removeAttribute(t) : e.setAttribute(t, n))
    }
    function K(e) {
    ...
    function Y(e, t, n) {
        ...
        for (r = 0; r < e.__k.length; r++)
            (o = e.__k[r]) && (o.__ = e,
            o.__e && ("function" == typeof o.type && o.__k.length > 1 && Y(o, t, n),
            t = H(n, o, o, e.__k, null, o.__e, t),
            "function" == typeof e.type && (e.__d = t)))
    }
    function Z(e, t, n, r, o, i, l, a, u) {
        var s, d, p, c, m, f, v, h, g, _, y, b = t.type;
        ...
        try {
            e: if ("function" == typeof b) {
                ...
                n.__c ? v = (d = t.__c = n.__c).__ = d.__E : ("prototype"in b && b.prototype.render ? t.__c = d = new b(h,_) : (t.__c = d = new z(h,_),
                d.constructor = b,
                d.render = oe),
                g && g.sub(d),
                d.props = h,
                ...
                null != b.getDerivedStateFromProps && (d.__s == d.state && (d.__s = L({}, d.__s)),
                ...
                p)
                    ...
                    if (null == b.getDerivedStateFromProps && h !== c && null != d.componentWillReceiveProps && d.componentWillReceiveProps(h, _),
                    !d.__e && null != d.shouldComponentUpdate && !1 === d.shouldComponentUpdate(h, d.__s, _) || t.__v === n.__v) {
                        d.props = h,
                        d.state = d.__s,
                        t.__v !== n.__v && (d.__d = !1),
                        d.__v = t,
                ...
                t.__e = n.__e) : t.__e = te(n.__e, t, n, r, o, i, l, u);
            (s = S.diffed) && s(t)
        } catch (e) {
            t.__v = null,
            (u || null != i) && (t.__e = a,
    ...
    function te(e, t, n, r, o, i, l, a) {
        var u, s, d, p, c, m = n.props, f = t.props;
        if (o = "svg" === t.type || o,
        null != i)
        ...
        if (null === t.type)
            ...
            if (null != i && (i = A.slice.call(e.childNodes)),
            ...
            p ? t.__k = [] : (u = t.props.children,
            B(e, Array.isArray(u) ? u : [u], t, n, r, "foreignObject" !== t.type && o, i, l, D, a)),
            a || ("value"in f && void 0 !== (u = f.value) && (u !== e.value || "progress" === t.type && !u) && X(e, "value", u, m.value, !1),
    ...
    function ie(e, t, n) {
        ...
        e = T(W, null, [e]),
        i = [],
        Z(t, (r ? t : n || t).__k = e, o || D, D, void 0 !== t.ownerSVGElement, n && !r ? [n] : o ? null : t.childNodes.length ? A.slice.call(t.childNodes) : null, i, n || D, r),
        ee(i, e)
    }
    S = {
        __e: function(e, t) {
    ...
    var le = function(e) {
        ...
        function l() {
            ...
            for (var r = arguments.length, i = new Array(r), a = 0; a < r; a++)
                i[a] = arguments[a];
            return o(p(e = n.call.apply(n, [this].concat(i))), "getInitialOverrideUrl", (function() {
            ...
            o(p(e), "getDerivedUrl", (function() {
                ...
                return ae.test(e.state.overrideUrl) ? window.importMapOverrides.getUrlFromPort(t, e.state.overrideUrl) : e.state.overrideUrl
            }
            )),
        ...
        return r(l, [{
            ...
            value: function(e) {
                ...
                }, n.moduleName), T("table", null, T("tbody", null, !n.isNew && T("tr", null, T("td", null, "Default URL:"), T("td", null, n.defaultUrl)), n.isNew && T("tr", null, T("td", null, T("span", {
                ...
                }, T("div", null, "ⓧ")))), T("tr", null, T("td", null, T("span", {
                ...
                }, T("div", null, "ⓧ")))), ae.test(this.state.overrideUrl) && T("tr", null, T("td", null, "Derived url:"), T("td", null, this.getDerivedUrl())))), T("div", {
                ...
                }, "Cancel"), this.props.module.overrideUrl && !this.props.module.disabled && T("button", {
                    type: "button",
                    onClick: function() {
                ...
                }, this.props.module.disabled ? "Enable" : "Disable", " Override"), T("button", {
                    type: "submit",
                    tabIndex: 7,
      ...
      , ue = function(e) {
        ...
        function l() {
            ...
            for (var r = arguments.length, i = new Array(r), a = 0; a < r; a++)
                i[a] = arguments[a];
            return o(p(e = n.call.apply(n, [this].concat(i))), "state", {
        ...
        return r(l, [{
            ...
            value: function() {
                ...
                }, this.props.dialogExternalMap.isNew ? "Add External Import Map" : "Edit External Import Map"), T("div", {
                    style: {
                        marginBottom: "20px"
                    }
                }, T("label", {
                    htmlFor: "external-importmap-url"
                }, "URL to import map:"), T("span", {
                    style: {
                        position: "relative"
                    }
                }, T("input", {
    ...
    function me() {
        return Object.keys(window.importMapOverrides.getOverrideMap().imports).filter((function(e) {
            return !pe[e]
        }
        )).length > 0
    }
    var fe = function(e) {
        ...
        return r(l, [{
            ...
            key: "componentDidUpdate",
            value: function(e, t) {
                !t.dialogModule && this.state.dialogModule ? (this.dialogContainer = document.createElement("div"),
                ...
                }), this.dialogContainer)) : t.dialogModule && !this.state.dialogModule && (ie(null, this.dialogContainer),
                this.dialogContainer.remove(),
                delete this.dialogContainer),
                !t.dialogExternalMap && this.state.dialogExternalMap ? (this.dialogContainer = document.createElement("div"),
                document.body.appendChild(this.dialogContainer),
                ie(T(ue, {
                    dialogExternalMap: this.state.dialogExternalMap,
                    cancel: this.cancel
                }), this.dialogContainer)) : t.dialogExternalMap && !this.state.dialogExternalMap && (ie(null, this.dialogContainer),
                this.dialogContainer.remove(),
                delete this.dialogContainer)
            }
        }, {
            ...
            value: function() {
                ...
                s.filter(this.filterModuleNames).forEach((function(s) {
                    ...
                    p.disabled ? r.push(p) : u[s] ? e.state.currentPageMap.imports[s] === u[s] ? pe[s] && pe[s](e.state.currentPageMap.imports[s]) === u[s] ? a.push(p) : t.push(p) : n.push(p) : e.state.notOverriddenMap.imports[s] === e.state.currentPageMap.imports[s] ? o.push(p) : e.state.notOverriddenMap.imports[s] === e.state.nextPageMap.imports[s] ? l.push(p) : i.push(p)
                }
                )),
                ...
                n.sort(ve);
                var p = function() {
                    var e, t = window.importMapOverrides.getExternalOverrides(), n = window.importMapOverrides.getCurrentPageExternalOverrides(), r = [], o = [], i = [], l = function(e, t) {
                        var n;
                ...
                return T("div", {
                ...
                }, "Add import map")), T("div", {
                    className: "imo-add-new"
                }, T("button", {
                    onClick: function() {
                        return window.importMapOverrides.resetOverrides()
                    }
                }, "Reset all overrides"))), T("table", {
                    className: "imo-overrides-table"
                }, T("thead", null, T("tr", null, T("th", null, "Module Status"), T("th", null, "Module Name"), T("th", null, "Domain"), T("th", null, "Filename"))), T("tbody", null, n.map((function(t) {
                    return T("tr", {
                        role: "button",
                        tabIndex: 0,
                        onClick: function() {
                    ...
                    }), T("div", null, "Inline Override"), T("div", {
                        className: "imo-needs-refresh"
                    })), T("td", null, t.moduleName), T("td", null, ge(t)), T("td", null, _e(t)))
                }
                )), l.map((function(t) {
                    return T("tr", {
                        role: "button",
                    ...
                    }), T("div", null, "Override disabled")), T("td", null, t.moduleName), T("td", null, ge(t)), T("td", null, _e(t)))
                }
                )), t.map((function(t) {
                    return T("tr", {
                        role: "button",
                    ...
                    }), T("div", null, "Inline Override")), T("td", null, t.moduleName), T("td", null, ge(t)), T("td", null, _e(t)))
                }
                )), i.map((function(t) {
                    return T("tr", {
                        role: "button",
                    ...
                    }), T("div", null, "External Override")), T("td", null, t.moduleName), T("td", null, ge(t)), T("td", null, _e(t)))
                }
                )), a.map((function(t) {
                    return T("tr", {
                        role: "button",
                    ...
                    }), T("div", null, "Dev Lib Override")), T("td", null, t.moduleName), T("td", null, ge(t)), T("td", null, _e(t)))
                }
                )), o.map((function(t) {
                    return T("tr", {
                        role: "button",
                    ...
                    }), T("div", null, "Default")), T("td", null, t.moduleName), T("td", null, ge(t)), T("td", null, _e(t)))
                }
                )))), (c.length > 0 || m.length > 0 || f.length > 0) && T("table", {
                    className: "imo-overrides-table"
                }, T("thead", null, T("th", null, "Import Map Status"), T("th", null, "URL")), T("tbody", null, c.map((function(t) {
                    return T("tr", {
                        role: "button",
                        tabIndex: 0,
                        onClick: function() {
                        ...
                        className: "imo-status imo-disabled-override"
                    }), T("div", null, "Invalid")), T("td", null, t))
                }
                )), f.map((function(t) {
                    return T("tr", {
                        role: "button",
                        ...
                        className: "imo-status imo-next-override"
                    }), T("div", null, "Pending refresh")), T("td", null, t))
                }
                )), m.map((function(t) {
                    return T("tr", {
                        role: "button",
                        ...
                        className: "imo-status imo-current-override"
                    }), T("div", null, "Override")), T("td", null, t))
                }
                )))))
            }
        }]),
    ...
    var we = function(e) {
        ...
        function l() {
            ...
            for (var r = arguments.length, i = new Array(r), a = 0; a < r; a++)
                i[a] = arguments[a];
            return o(p(e = n.call.apply(n, [this].concat(i))), "doUpdate", (function() {
        ...
        return r(l, [{
            ...
            value: function(e) {
                ...
                }, T("div", null, T("h1", null, "Import Map Overrides"), T("p", null, "This developer tool allows you to view and override your import maps. Start by clicking on a module that you'd like to override.", " ", T("a", {
                    target: "_blank",
                    href: "https://github.com/joeldenning/import-map-overrides"
                }, "See documentation for more info"), ".")), T("button", {
      ...
      , xe = function(e) {
        ...
        return r(l, [{
            ...
            key: "render",
            value: function(e, t) {
                return e.customElement.hasAttribute("show-when-local-storage") && "true" !== localStorage.getItem(e.customElement.getAttribute("show-when-local-storage")) ? null : T("div", null, T("button", {
                    onClick: this.toggleTrigger,
                    className: "imo-unstyled imo-trigger ".concat(this.atLeastOneOverride() ? "imo-current-override" : "")
                }, "{···}"), this.useDevLibs() && T(se, null), t.showingPopup && T(we, {
    ...
    window.customElements && !y && (window.customElements.define("import-map-overrides-full", Me(xe, ["show-when-local-storage"])),
