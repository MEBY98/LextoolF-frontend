<template>
  <svg
    ...
    style="width: 430"
  >
    <rect x="615.00687" y="108" width="182" height="332" fill="#e6e6e6"></rect>
    <path
    ...
    <rect
      ...
      fill="#e6e6e6"
    ></rect>
    <rect x="107.00687" y="108" width="182" height="332" fill="#e6e6e6"></rect>
    <path
    ...
    <ellipse
      ...
      fill="#e6e6e6"
    ></ellipse>
    <rect x="328.1153" width="247.78313" height="452" fill="#3f3d56"></rect>
    <path
    ...
    <path
      ...
      fill="#ffb8b8"
    ></path>
    <circle cx="317.00687" cy="158" r="20" fill="#ffb8b8"></circle>
    <path
